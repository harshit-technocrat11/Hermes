...
export function UserMenu({ workspaceSlug }: UserMenuProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="w-6 h-6 bg-gradient-to-br from-green-400 to-blue-500 rounded flex items-center justify-center text-white text-xs font-bold">
          AR
        </div>
        <span className="text-sm hidden sm:block">Alex Rivera</span>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-slate-800 border border-slate-700 rounded-lg shadow-xl overflow-hidden z-50">
          <div className="p-4 border-b border-slate-700">
            ...
            <p className="text-xs text-slate-400">alex@nexus.so</p>
          </div>
          ...
          <div className="p-2 border-t border-slate-700">
            <button className="flex items-center gap-3 px-3 py-2 w-full text-sm text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200">
